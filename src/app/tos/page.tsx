...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to AI CV Builder. These Terms of Service (&quot;Terms&quot;)
        govern your use of our website and services, including any paid
        subscription plans. By accessing or using AI CV Builder (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        AI CV Builder is a SaaS platform that provides CV-building tools
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> AI CV Builder does not offer
      ...
      <p>
        AI CV Builder grants you a limited, non-exclusive, non-transferable,
      ...
      <p>
        ...
        CV Builder are owned by AI CV Builder or its licensors. You
        agree not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant AI CV Builder a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). AI CV Builder is not
      ...
      <p>
        ...
        available&quot; basis. AI CV Builder makes no warranties, express or
        implied, regarding the Service, including but not limited to the
        accuracy of CV outputs, the suitability of resumes for job
      ...
      <p>
        To the fullest extent permitted by law, AI CV Builder shall not be
      ...
      <p>
        By using AI CV Builder, you acknowledge that you have read,
