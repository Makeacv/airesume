  ...
  return (
    <>
      <main className="max-w-3xl mx-auto px-4 py-24">
        ...
        <p className=" text-gray-700 dark:text-zinc-400 mb-4 text-justify">
        ...
        <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">
